...
class ProsesBisnisResource extends JsonResource
{
    /**
    ...
    {
        $baseUrl = 'https://e-sakip.trenggalekkab.go.id/preview/proses-bisnis/';
        $storageUrl = 'https://e-sakip.trenggalekkab.go.id/storage/proses-bisnis/';
