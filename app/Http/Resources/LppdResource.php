...
class LppdResource extends JsonResource
{
    /**
    ...
    {
        $baseUrl = 'https://e-sakip.trenggalekkab.go.id/preview/lppd/';
        $storageUrl = 'https://e-sakip.trenggalekkab.go.id/storage/lppd/';
