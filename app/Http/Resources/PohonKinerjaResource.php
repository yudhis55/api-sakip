...
class PohonKinerjaResource extends JsonResource
{
    /**
    ...
    {
        $baseUrl = 'https://e-sakip.trenggalekkab.go.id/preview/cascading/';
        $storageUrl = 'https://e-sakip.trenggalekkab.go.id/storage/cascading/';
