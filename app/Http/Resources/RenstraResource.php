...
class RenstraResource extends JsonResource
{
    /**
    ...
    {
        $baseUrl = 'https://e-sakip.trenggalekkab.go.id/preview/renstra/';
        $storageUrl = 'https://e-sakip.trenggalekkab.go.id/storage/renstra/';
