...
class RpjmdResource extends JsonResource
{
    /**
    ...
    {
        $baseUrl = 'https://e-sakip.trenggalekkab.go.id/preview/rpjmd/';
        $storageUrl = 'https://e-sakip.trenggalekkab.go.id/storage/rpjmd/';
