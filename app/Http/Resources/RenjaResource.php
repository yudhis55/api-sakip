...
class RenjaResource extends JsonResource
{
    /**
    ...
    {
        $baseUrl = 'https://e-sakip.trenggalekkab.go.id/preview/renja/';
        $storageUrl = 'https://e-sakip.trenggalekkab.go.id/storage/renja/';
